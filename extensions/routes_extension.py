...
from apps.api.controllers.message_meta import blueprint as message_meta_bp
...
from apps.api.controllers.user_meta import blueprint as user_meta_bp
...
def register_routes(app: Flask):
    ...
    app.register_blueprint(message_meta_bp)
