...
from core.domain.schema.TokenBlocListSchema import TokenBlocListSchema
...
def get_bloc_tokens():
    ...
    result = TokenBlocListSchema().dump(WPTokenBlocList.get(page_index, page_size).all(), many=True)
    return jsonify(
        {
